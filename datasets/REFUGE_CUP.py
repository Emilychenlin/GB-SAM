...
class REFUGE_CUPDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if image is None:
           raise FileNotFoundError(f"[REFUGE_CUPDataset] failed to load image: {image_path}")
...
def load_datasets(cfg, img_size):
    ...
    test = REFUGE_CUPDataset(
        cfg,
        root_dir=cfg.datasets.REFUGE_CUP.test_dir,
        list_file=cfg.datasets.REFUGE_CUP.test_list,
        transform=transform,
    )
    val = REFUGE_CUPDataset(
        cfg,
        root_dir=cfg.datasets.REFUGE_CUP.val_dir,
        list_file=cfg.datasets.REFUGE_CUP.val_list,
        transform=transform,
    )
    train = REFUGE_CUPDataset(
        cfg,
        root_dir=cfg.datasets.REFUGE_CUP.train_dir,
        list_file=cfg.datasets.REFUGE_CUP.train_list,
        transform=transform,
