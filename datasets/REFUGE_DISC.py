...
class REFUGE_DISCDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if image is None:
           raise FileNotFoundError(f"[REFUGE_DISCDataset] failed to load image: {image_path}")
...
def load_datasets(cfg, img_size):
    ...
    test = REFUGE_DISCDataset(
        cfg,
        root_dir=cfg.datasets.REFUGE_DISC.test_dir,
        list_file=cfg.datasets.REFUGE_DISC.test_list,
        transform=transform,
    )
    val = REFUGE_DISCDataset(
        cfg,
        root_dir=cfg.datasets.REFUGE_DISC.val_dir,
        list_file=cfg.datasets.REFUGE_DISC.val_list,
        transform=transform,
    )
    train = REFUGE_DISCDataset(
        cfg,
        root_dir=cfg.datasets.REFUGE_DISC.train_dir,
        list_file=cfg.datasets.REFUGE_DISC.train_list,
        transform=transform,
